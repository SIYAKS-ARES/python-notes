...
if(sayi == 0):# "=" atama operatörüyken (Ps. işaretin sağındaki değeri alıp soldakine atama), "==" karşılaştırma operatörüdür.
    ...
    # Python'da çıkıntı yöntemi kullanılır, koşulun bir alt çıkıntısı içeriye girildiği zaman yapılacak kodları barındırır.
elif(sayi < 0):
    print("Sayi sifirdan kucukutur")
elif(sayi > 0):
    print("Sayi sifirdan buyuktur")
else:
    print ("Girilen sayi rasyonel sayi değildir")
...
if(kullaniciAdi == "SIYAKSARES" and kullaniciSifresi == "1234"):
    ...
    print("Girilen bilgiler hatalidir, cikis yapiliyor!")
