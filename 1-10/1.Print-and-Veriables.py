...
'''
sayi = 20 # Bu şekilde hafızada sayi isminde bir alan oluşturuldu ve bu alanda 20 sayisi tutulur.
print (sayi)
isim = "SIYAKSARES" # String yapılarında da aynı şekilde değişken oluşturulur, tek fark "" açmanin gerekmesidir.
print (isim)
