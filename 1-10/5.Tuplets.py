# Demetler/Tuple'lar ile liste gibi yapılar oluşturulur tek fark eklenen veriler değiştirilemez.
...
sabitler = (3.12, 3.13, 3.14, 3.15) # Listede "[]" kullanılırken tuple'larda "()" kullanılır.
print (sabitler)
